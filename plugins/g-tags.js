...
teks += `· ⟢  @${mem.id.split('@')[0]}\n`}
conn.sendMessage(m.chat, { text: `${teks}`, contextInfo: { externalAdReply: { title: '⫶☰ B I E N V E N I D O', body: '🝐 Este es el listado de menus disponibles.', thumbnailUrl: mxMenu3, sourceUrl: null, mediaType: 1, showAdAttribution: false, renderLargerThumbnail: false }}, mentions: conn.parseMention(teks)}, { quoted: m }) //Imagen personalizada con una imagen pequeña.
